...
export const QURAN_SURAHS: Surah[] = [
  ...
  { number: 28, name: "Al-Qashash", verses: 88 },
  ...
  { number: 35, name: "Fathir", verses: 45 },
  ...
  { number: 65, name: "At-Thalaq", verses: 12 },
  ...
  { number: 74, name: "Al-Muddassir", verses: 56 },
  ...
  { number: 83, name: "Al-Muthaffifin", verses: 36 },
  { number: 84, name: "Al-Insyiqaq", verses: 25 },
  { number: 85, name: "Al-Buruj", verses: 22 },
  { number: 86, name: "At-Thariq", verses: 17 },
  ...
  { number: 108, name: "Al-Kausar", verses: 3 },
